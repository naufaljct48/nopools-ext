...
var _Sources = (() => {
  ...
  // src/KomikIndoTop/KomikIndoTop.ts
  var KomikIndoTop_exports = {};
  __export(KomikIndoTop_exports, {
    KomikIndoTop: () => KomikIndoTop,
    KomikIndoTopInfo: () => KomikIndoTopInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/KomikIndoTop/KomikIndoTop.ts
  var DOMAIN = "https://komikindo.fit";
  var KomikIndoTopInfo = {
  ...
  var KomikIndoTop = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(KomikIndoTop_exports);
})();
