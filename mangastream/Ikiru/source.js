...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Ikiru = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
    configureSections() {
      ...
      this.homescreen_sections["popular_today"].selectorFunc = ($2, element) => $2("div.bsx", $2("h3:contains(Popular Today)")?.parent()?.next());
      this.homescreen_sections["latest_update"].selectorFunc = ($2, element) => $2("div.utao", $2("h3:contains(Latest Update)")?.parent()?.next());
    }
  };
