...
var _Sources = (() => {
  ...
  var KomikuAsia_exports = {};
  __export(KomikuAsia_exports, {
    KomikuAsia: () => KomikuAsia,
    KomikuAsiaInfo: () => KomikuAsiaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var KomikuAsiaInfo = {
    version: getExportVersion("1.0.5"),
    name: "KomikuAsia",
  ...
  var KomikuAsia = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].selectorFunc = ($2, element) => $2("div.uta", $2("h2:contains(Rilisan Terbaru)")?.parent()?.next());
