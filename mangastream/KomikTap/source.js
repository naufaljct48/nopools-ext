...
var _Sources = (() => {
  ...
  var KomikTap_exports = {};
  __export(KomikTap_exports, {
    KomikTap: () => KomikTap,
    KomikTapInfo: () => KomikTapInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var getSearchTagsKomikTap = async (source) => {
    const request = App.createRequest({
      url: `${source.baseUrl}/manga/?page=1&order=update`,
      method: "GET"
    });
  ...
  var getCloudflareBypassUrlKomikTap = (baseUrl) => `${baseUrl}/manga/?page=1&order=update`;
  ...
  var KomikTap = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
