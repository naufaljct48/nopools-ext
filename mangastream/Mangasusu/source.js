...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Mangasusu = class extends MangaStream {
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].selectorFunc = ($2, element) => $2("div.stylesven", $2("h2:contains(Latest Update)")?.parent()?.next());
      this.homescreen_sections["latest_update"].subtitleSelectorFunc = ($2, element) => $2("ul.svenchapters.Manhwa li:first-child a", element).first().text().trim();
    }
  };
