...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Kanzenin = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.homepageListingUrl = `${DOMAIN}/manga/?page=1&order=update`;
      this.homepageSections = [
        { url: `${DOMAIN}/manga/?page=1&status=&type=&order=update`, sectionKey: "latest_update" },
        { url: `${DOMAIN}/manga/?order=popular`, sectionKey: "popular_today" }
      ];
      this.dateMonths = {
        january: "januari",
        february: "februari",
