...
var _Sources = (() => {
  ...
  var Kanzenin_exports = {};
  __export(Kanzenin_exports, {
    Kanzenin: () => Kanzenin,
  ...
  var Tokenizer2 = class {
    ...
    emitNumericEntity(strict2) {
      ...
      if (numberStart !== this.index) {
        ...
        this.sectionStart = this.index + Number(strict2);
  ...
  var fromCodePoint3 = String.fromCodePoint || function(astralCodePoint) {
  ...
  function getDecodedEntity(entity, references, isAttribute, isStrict) {
    ...
    if (isAttribute && decodeEntityLastChar === "=") {
      ...
      if (decodeResultByReference) {
        ...
        decodeResult = decodeCode >= 1114111 ? outOfBoundsChar : decodeCode > 65535 ? fromCodePoint3(decodeCode) : fromCharCode(numericUnicodeMap[decodeCode] || decodeCode);
      }
    }
    return decodeResult;
  }
  function decode(text3, _a3) {
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/Kanzenin/KanzeninHelper.ts
  var getHomePageSectionsKanzenin = async (source, sectionCallback) => {
    const sections = [
      {
  ...
  var getSearchTagsKanzenin = async (source) => {
    const request = App.createRequest({
  ...
  var getCloudflareBypassUrlKanzenin = (baseUrl) => `${baseUrl}/manga/?page=1&order=update`;
  ...
  var Kanzenin = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.dateMonths = {
