...
var _Sources = (() => {
  ...
  var Pojokmanga_exports = {};
  __export(Pojokmanga_exports, {
    Pojokmanga: () => Pojokmanga,
    PojokmangaInfo: () => PojokmangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Pojokmanga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(Pojokmanga_exports);
})();
